...
import static com.farhad.example.gamefification.shared.domain.common.DomainEventType.STUDENT_REGISTERED_TO_CLASS_ROOM_BY_INDICATION_EVENT;
...
public class StudentRegisteredToClassRoomByIndicationEvent implements DomainEvent {
    ...
    public DomainEventType eventType() {
        return STUDENT_REGISTERED_TO_CLASS_ROOM_BY_INDICATION_EVENT;
    }
